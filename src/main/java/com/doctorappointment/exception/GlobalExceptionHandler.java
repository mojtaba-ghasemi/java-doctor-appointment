...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleErrorMessageException(ErrorMessageException errorMessageException, WebRequest request) {
        log.error("Failed to run service: " , errorMessageException.errorMessage);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body((errorMessageException).getErrorMessage());
    }
